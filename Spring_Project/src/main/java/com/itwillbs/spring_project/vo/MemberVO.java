...
public class MemberVO {
	...
	public String toString() {
		return "MemberVO [grade_name=" + grade_name + ", lowest_acc_money=" + lowest_acc_money + ", highest_acc_money="
				+ highest_acc_money + ", discount_rate=" + discount_rate + ", reason_num=" + reason_num
				+ ", reason_content=" + reason_content + ", member_num=" + member_num + ", member_code=" + member_code
				+ ", member_nickname=" + member_nickname + ", member_id=" + member_id + ", member_passwd="
