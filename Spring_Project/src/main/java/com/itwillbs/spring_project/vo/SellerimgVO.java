...
public class SellerimgVO {
	...
	public SellerimgVO(int sell_img_real_num, int sell_img_num, String sell_img_name, String sell_img_real_name) {
		super();
	...
	public String toString() {
		return "SellerimgVO [sell_img_real_num=" + sell_img_real_num + ", sell_img_num=" + sell_img_num
